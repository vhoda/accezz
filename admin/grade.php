...
<div class="container" style="margin-top:30px">
  <div class="card shadow">
      ...
      <div class="row">
        <div class="col-md-9">Lista de Cursos</div>
        <div class="col-md-3" align="right">
          <button type="button" id="add_button" class="btn btn-success btn-sm">Agregar Curso</button>
        </div>
      </div>
    </div>
  	<div class="card-body">
...
<div class="modal" id="deleteModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Confirmar en Eliminar</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body">
        <h3 align="center">Estas seguro en Eliminar El curso?</h3>
      </div>
...
$(document).ready(function(){
  ...
  $('#add_button').click(function(){
    $('#modal_title').text('Agregar Curso');
