...
<div class="container" style="margin-top:30px">
  <div class="card shadow">
      ...
      <div class="row">
        <div class="col-md-9">Lista de Asistencias</div>
        <div class="col-md-3" align="right">
          <!--<button type="button" id="chart_button" class="btn btn-primary btn-sm">Chart</button>-->
          <!--<button type="button" id="report_button" class="btn btn-danger btn-sm">Resumir a PDF</button>-->
        </div>
      </div>
    </div>
  	<div class="card-body">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Hacer Resumen</h4>
      ...
      <div class="modal-footer">
        <button type="button" name="create_report" id="create_report" class="btn btn-success btn-sm">Crear Resumen</button>
...
$(document).ready(function(){
  ...
  $('#create_report').click(function(){
    ...
    if(from_date == '')
    {
      $('#error_from_date').text('Desde es requerido');
      error++;
    }
    else
    {
    ...
    if(to_date == '')
    {
      $('#error_to_date').text("Hasta es requerida");
      error++;
    }
    else
    {
