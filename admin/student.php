...
<div class="container" style="margin-top:30px">
  <div class="card shadow">
      ...
      <div class="row">
        <div class="col-md-9">Lista de Estudiantes</div>
        <div class="col-md-3" align="right">
        	<button type="button" id="add_button" class="btn btn-success btn-sm">Agregar Estudiante</button>
        </div>
      </div>
    </div>
  	<div class="card-body">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Nombre del Estudiante <span class="text-danger">*</span></label>
              <div class="col-md-8">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">n° <span class="text-danger">*</span></label>
              <div class="col-md-8">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Fecha de nacimiento <span class="text-danger">*</span></label>
              <div class="col-md-8">
  ...
  $(document).on('click', '.edit_student', function(){
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        $('#modal_title').text('Editar estudiante');
