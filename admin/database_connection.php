...
$connect = new PDO("mysql:host=sql205.epizy.com;dbname=epiz_31691345_bd","epiz_31691345","ECkZIOv4oAQQ");



$base_url = "http://vhoda.lol/accezz/";
...
function Get_student_apoderado_name($connect, $student_id)

{

	$query = "

	SELECT tbl_apoderado.apoderado_name 
	...
	INNER JOIN tbl_apoderado 

	ON tbl_apoderado.apoderado_grade_id = tbl_grade.grade_id 
