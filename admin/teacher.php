...
<div class="container" style="margin-top:30px">
  <div class="card shadow">
      ...
      <div class="row">
        <div class="col-md-9">Lista de Docentes</div>
        <div class="col-md-3" align="right">
          <button type="button" id="add_button" class="btn btn-success btn-sm">Agregar Docente</button>
        </div>
      </div>
    </div>
  	<div class="card-body">
...
$(document).ready(function(){
  ...
  $('#add_button').click(function(){
    $('#modal_title').text("Agregar Docente");
  ...
  $(document).on('click', '.edit_teacher', function(){
  	...
  	$.ajax({
  		...
  		success:function(data)
  		{
  			...
  			$('#modal_title').text('Editar Profesor');
