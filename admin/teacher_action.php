...
if(isset($_POST["action"]))
{
	if($_POST["action"] == "fetch")
	{
		...
		foreach($result as $row)
		{
			...
			$sub_array[] = '<button type="button" name="view_teacher" class="btn btn-dark btn-sm view_teacher" id="'.$row["teacher_id"].'">Ver</button>';
			$sub_array[] = '<button type="button" name="edit_teacher" class="btn btn-primary btn-sm edit_teacher" id="'.$row["teacher_id"].'">Editar</button>';
			$sub_array[] = '<button type="button" name="delete_teacher" class="btn btn-danger btn-sm delete_teacher" id="'.$row["teacher_id"].'">Eliminar</button>';
			$data[] = $sub_array;
		}
		$output = array(
