...
<div class="container" style="margin-top:30px">
  <div class="card shadow">
      ...
      <div class="row">
        <div class="col-md-9">Resumen general</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Resumir</h4>
      ...
      <div class="modal-body">
        <div class="mb-3 col-auto">
          <select name="report_action" id="report_action" class="form-control">
            <option value="pdf_report">Resumir en PDF</option>
...
$(document).ready(function(){
   ...
   $('#create_report').click(function(){
    ...
    if(from_date == '')
    {
      $('#error_from_date').text('Del desde es Requerido');
      error++;
    }
    else
    {
