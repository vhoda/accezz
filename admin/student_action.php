...
if(isset($_POST["action"]))
{
	if($_POST["action"] == "fetch")
	{
		...
		foreach($result as $row)
		{
			...
			$sub_array[] = '<button type="button" name="edit_student" class="btn btn-primary btn-sm edit_student" id="'.$row["student_id"].'">Editar</button>';
			$sub_array[] = '<button type="button" name="delete_student" class="btn btn-danger btn-sm delete_student" id="'.$row["student_id"].'">Eliminar</button>';
			$data[] = $sub_array;
		}
		$output = array(
	...
	if($_POST["action"] == 'Add' || $_POST["action"] == "Edit")
	{
		...
		{
			$error_student_name = 'Nombre Estudiante es requerido';
			$error++;
		}
		else
		{
		...
		{
			$error_student_roll_number = 'Numero estudiante es requerido';
			$error++;
		}
		else
		{
		...
		{
			$error_student_dob = 'Fecha de nacimiento es requerido';
			$error++;
		}
		else
		{
		...
		{
			$error_student_grade_id = "Curso es requerido";
			$error++;
		}
		else
		{
