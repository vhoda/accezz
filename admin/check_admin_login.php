...
{
	$error_admin_user_name = 'El campo Usuario es requerido..';
	$error++;
}
else
{
...
{
	$error_admin_password = 'La contraseña es requerida..';
	$error++;
}
else
{
	...
	if($statement->execute())
	{
		...
		if($total_row > 0)
		{
			...
			foreach($result as $row)
			{
				...
				{
					$error_admin_password = "Contraseña incorrecta.";
					$error++;
				}
			}
		}
		...
		{
			$error_admin_user_name = 'Correo incorrecto - no Existente.';
			$error++;
		}
	}
}
