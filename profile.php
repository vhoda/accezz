...
if(isset($_POST["button_action"]))
{
	...
	if($error == 0)
	{
		...
		{
			$success = '<div class="alert alert-success">Cambios realizados Correctamente!</div>';
		}
	}
}
  ...
  <div class="card">
    <form method="post" id="profile_form" enctype="multipart/form-data">
		<div class="card-header">
			<div class="row">
				<div class="col-md-9"><i class="fa-solid fa-user-pen"></i> Perfil</div>
		...
		<div class="card-body">
			<div class="mb-3 col-auto">
				<div class="row">
					<label class="col-md-4 text-right">Nombre del Docente: <span class="text-danger">*</span></label>
					<div class="col-md-8">
			...
			<div class="mb-3 col-auto">
				<div class="row">
					<label class="col-md-4 text-right">Direccion: <span class="text-danger">*</span></label>
					<div class="col-md-8">
			...
			<div class="mb-3 col-auto">
				<div class="row">
					<label class="col-md-4 text-right">Dirección del Domicilio: <span class="text-danger">*</span></label>
					<div class="col-md-8">
			...
			<div class="mb-3 col-auto">
				<div class="row">
					...
					<div class="col-md-8">
						<input type="password" name="teacher_password" id="teacher_password" class="form-control" placeholder="Deje en blanco para no Realizar cambios" />
			...
			<div class="mb-3 col-auto">
				<div class="row">
					<label class="col-md-4 text-right">Fecha ingresado: <span class="text-danger">*</span></label>
					<div class="col-md-8">
			...
			<div class="mb-3 col-auto">
				<div class="row">
					...
					<div class="col-md-8">
						...
						<span class="text-muted">Solo .jpg & .png Soportan</span><br />
		...
		<div class="card-footer" align="center">
			...
			<input type="submit" name="button_action" id="button_action" class="btn btn-success btn-sm" value="Guardar" />
		</div>     
    </form>
  </div>
</div>
