...
<div class="container" style="margin-top:30px">
  <div class="card shadow">
      ...
      <div class="row">
        <div class="col-md-9">Resumen general de asistencia de los estudiantes</div>
      ...
      <div class="modal-body">
        <div class="form-group">
          <div class="input-daterange">
            <input type="text" name="from_date" id="from_date" class="form-control" placeholder="Del día" readonly />
