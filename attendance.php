<title>Agregar Asistencia - Accezz</title>
<?php
...
<div class="container" style="margin-top:30px">
  <div class="card">
      ...
      <div class="row">
        <div class="col-md-9">Lista de Asistencia</div>
        <div class="col-md-3" align="right">
          <button type="button" id="add_button" class="btn btn-success btn-sm">Registrar Asistencia</button>
        </div>
      </div>
    </div>
  	<div class="card-body">
    ...
    <form method="post" id="attendance_form">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <input type="submit" name="button_action" id="button_action" class="btn btn-success btn-sm" value="Registrar" />
...
$(document).ready(function(){
  ...
  $('#add_button').click(function(){
    $('#modal_title').text("Registrar Asistencia");
